    ...
    <main className={styles.mainContainer}>
      <div className={styles.videoContainer}>
        <div className={styles.videoItem}>
          ...
          >
            <br></br>
            <b className={styles.title}>CASO 1</b>
            ...
            <p className={styles.description}>
              ...
              mãos”
              <br />
              <br />O nosso cliente decidiu acabar com a calvície de forma
              rápida, eficaz e segura, e além disso, Fomos escolhidos pela
              qualidade e realismo do nosso trabalho.
            </p>
          </div>
          <br></br>
